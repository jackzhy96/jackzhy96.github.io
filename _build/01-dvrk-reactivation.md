...
- Configured dVRK controllers for all robot arms
- Integrated software stack with hardware components
- Performed calibration and validation procedures
- Enabled full teleoperation capability
